...
| 2026-07-23 | **Polish R1/R2**: live-feed split into a primary Notices stream (new `NOTICE` type, amber, Saira 10px) + a demoted System Log; first-class empty/loading/error state over the globe. **R3 (marker hue tuning) skipped by design** — not needed, net-negative risk. CI green. |
